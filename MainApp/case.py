...
class ViewCase(qt.QDialog):
    ...
    def view_case(self, patient_id, case_id=None):
        ...
        if case is not None:
            ...
            cc_loc_row = qt.QHBoxLayout()
            cc_loc_row.addWidget(qt.QLabel(case[0]))
            cc_loc_row.addStretch()
            cc_loc_vbox.addLayout(cc_loc_row)
            ...
            cc_sen_row = qt.QHBoxLayout()
            cc_sen_row.addWidget(qt.QLabel(case[1]))
            cc_sen_row.addStretch()
            cc_sen_vbox.addLayout(cc_sen_row)
            ...
            cc_con_row = qt.QHBoxLayout()
            cc_con_row.addWidget(qt.QLabel(case[4]))
            cc_con_row.addStretch()
            cc_con_vbox.addLayout(cc_con_row)
            ...
            if case[6] != '' or case[7] != '' or case[8] != '' or case[9] != '' or case[10] != '' or case[11] != '':
                ...
                for ac_num, (ac_loc_data, ac_sen_data, ac_ame_data, ac_agg_data, ac_con_data, ac_alp_data) \
                    ...
                    ac_loc_row = qt.QHBoxLayout()
                    ac_loc_row.addWidget(qt.QLabel(ac_loc_data))
                    ac_loc_row.addStretch()
                    ac_loc_vbox[ac_num].addLayout(ac_loc_row)
                    ...
                    ac_sen_row = qt.QHBoxLayout()
                    ac_sen_row.addWidget(qt.QLabel(ac_sen_data))
                    ac_sen_row.addStretch()
                    ac_sen_vbox[ac_num].addLayout(ac_sen_row)
                    ...
                    ac_con_row = qt.QHBoxLayout()
                    ac_con_row.addWidget(qt.QLabel(ac_con_data))
                    ac_con_row.addStretch()
                    ac_con_vbox[ac_num].addLayout(ac_con_row)
